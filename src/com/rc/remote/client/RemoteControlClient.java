...
public class RemoteControlClient {
	...
	public static void ready() throws Exception {
		System.out.println(Constants.createClientConnectionSuccessfulMessage(InetAddress.getLocalHost().getHostName(),
	...
	public static void askLogicOperation(IRemoteControl provider) throws Exception {
		...
		boolean result = provider.makeLogicOperation(Integer.parseInt(arg1), operation, Integer.parseInt(arg2));
