...
public interface IRemoteControl extends Remote {
	 ...
	 * 
	 * @param operation The operation to be with the given arguments. It must be one of the following: "equal", "greaterThan" or "lessThan".
	 * 
	 * @throws IllegalArgumentException if the operation argument is empty or if it isn't a valid operation. 
	 * 
